// Tabla de donaciones del panel de organizacion, con seleccion multiple
// para actualizar el estado de varias donaciones a la vez.
import React from 'react'
import ErrorView from '../../components/ErrorView'
import SkeletonRows from '../admin/SkeletonRows'
import { formatDate, donationStatusLabel } from '../admin/adminHelpers'
import '../MisDonaciones.css'

export default function OrgaDonacionesTable({
    donaciones,
    loadingDonaciones,
    donacionesError,
    selectedIds,
    ...
    if (!loadingDonaciones && donaciones.length === 0) {
        return (
            <div className="empty-box">
                No hay donaciones registradas para tu organización.
            </div>
        )
    }
    ...
    return (
        <div className="admin-table-wrap">
            <table className="admin-table admin-table-donaciones">
                <thead>
                    <tr>
                        <th>
                            <input
